...
For Practicum 3, we will be using the same dataset **NYC Green Taxis from 2018**. Our main objective is to evaluate the factors that contribute toward cab drivers being incentivized (i.e what determines whether or not they receive a tip).
